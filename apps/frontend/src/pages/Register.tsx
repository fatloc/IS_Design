...
// ── Role options ───────────────────────────────────────────────────────────
const ROLES = [
  { id: "manager", label: "Quản lý", sub: "Toàn quyền hệ thống", icon: ShieldCheck, color: "#4F46E5", light: "#EEF2FF", border: "#C7D2FE" },
  { id: "sale", label: "Nhân viên Sale", sub: "Quản lý khách & HĐ", icon: TrendingUp, color: "#EA580C", light: "#FFF7ED", border: "#FED7AA" },
  { id: "accountant", label: "Kế toán", sub: "Tài chính & Kế toán", icon: BarChart3, color: "#059669", light: "#ECFDF5", border: "#6EE7B7" },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-auto flex items-start justify-center py-8 px-4">
        ...
        <div className="fixed bottom-1/4 right-1/4 w-64 h-64 rounded-full pointer-events-none" style={{
          zIndex: 1,
          background: `radial-gradient(circle,rgba(30,58,138,0.3) 0%,transparent 70%)`, filter: "blur(30px)"
        }} />

        {/* ── Registration Card ──────────────────────────────────────────── */}
        <div className="relative z-10 w-full" style={{ maxWidth: 1120, marginTop: 12, marginBottom: 12 }}>
          <div className="rounded-3xl overflow-hidden"
            style={{ background: "white", boxShadow: "0 30px 80px rgba(0,0,0,0.35), 0 0 0 1px rgba(255,255,255,0.08)" }}>

            {/* ── Card Top Banner ── */}
            <div className="relative px-6 pt-6 pb-5 lg:px-8 lg:pt-7 lg:pb-5 overflow-hidden"
            ...
            {/* ── Form Body ── */}
            <div className="px-6 py-5 lg:px-7 lg:py-5">
              ...
              <div className="grid gap-5 lg:grid-cols-2 lg:gap-6 lg:items-start">
                          ...
                          <div className="grid grid-cols-2 gap-x-3 gap-y-1 mb-1">
                            {[
                              ...
                              <div key={i} className="flex items-center gap-1 min-w-0">
                                ...
                                <span className="truncate" style={{ fontSize: "0.65rem", color: r.check ? TEAL : "#94A3B8", fontWeight: r.check ? 700 : 400 }}>
                                  {r.label}
                                </span>
                              </div>
                            ))}
                ...
                <div className="space-y-5">
                      ...
                      {ROLES.map(r => {
                        ...
                        return (
                          <button key={r.id} type="button" onClick={() => setRole(r.id)}
                            className="relative flex flex-col items-center gap-2 px-3 py-3.5 rounded-2xl transition-all text-center"
                            style={{
                            ...
                            <div className="w-11 h-11 rounded-2xl flex items-center justify-center"
                              ...
                              <RIcon size={20} style={{ color: isSelected ? "white" : r.color }} />
                            </div>
                            <div>
                              <div style={{ fontWeight: 800, fontSize: "0.84rem", color: isSelected ? r.color : "#1E293B", transition: "color .15s" }}>
                                {r.label}
                              </div>
                              <div style={{ fontSize: "0.66rem", color: isSelected ? r.color + "90" : "#94A3B8", marginTop: 2 }}>
                                {r.sub}
                              </div>
                            </div>
                          </button>
                  ...
                  <div className="space-y-3 reg-fade-5">
              ...
              {/* Footer */}
              <div className="text-center mt-5" style={{ fontSize: "0.72rem", color: "#CBD5E1" }}>
