...
import { saleRequests as saleRequestsMock } from "../../data/saleMockData";
...
export default function SaleRequests() {
  ...
  return (
    <div className="space-y-5">
      {isUsingMockData && (
        <div className="flex items-start gap-2.5 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-amber-800 text-sm">
          <AlertCircle size={16} className="mt-0.5" />
          <span>Đang hiển thị dữ liệu mẫu vì API yêu cầu chưa sẵn sàng.</span>
        </div>
      )}
