                  ...
                  <div className="space-y-4">
                    {todayAppointments.sort((a, b) => a.time.localeCompare(b.time)).map((apt) => (
                      <div key={apt.id} className="flex gap-4 items-start group">
                        ...
                        <div className={`relative z-10 w-3 h-3 rounded-full flex-shrink-0 mt-1 border-2 border-white ${apt.status === "Shown" ? "bg-emerald-400" :
                            apt.status === "Cancelled" ? "bg-red-400" : "bg-blue-400"
                          }`} />
                        <div className={`flex-1 rounded-xl p-3.5 border transition-all ${apt.status === "Shown" ? "bg-emerald-50 border-emerald-100" :
                          ...
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className={`text-xs px-2 py-0.5 rounded-full ${apt.rentalMode === "Whole Room" ? "bg-violet-100 text-violet-700" : "bg-teal-100 text-teal-700"
                            ...
                            <span className={`text-xs px-2 py-0.5 rounded-full flex-shrink-0 ${apt.status === "Shown" ? "bg-emerald-100 text-emerald-700" :
              ...
              <div key={req.id} className="px-5 py-3.5 hover:bg-slate-50 transition cursor-pointer">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2.5">
                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-xs ${req.rentalMode === "Whole Room" ? "bg-violet-100 text-violet-700" : "bg-teal-100 text-teal-700"
              ...
              return (
                <div key={status} className="text-center">
                  ...
                  <div className="mt-2 h-1 bg-slate-100 rounded-full overflow-hidden">
                    <div className={`h-full rounded-full ${status === "Deposited" ? "bg-emerald-400" : status === "Cancelled" ? "bg-slate-300" :
