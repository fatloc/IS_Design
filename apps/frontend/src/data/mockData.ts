...
export const showingAppointments: ShowingAppointment[] = [
  { id: "SA001", guest: "Nguyễn Thái Sơn", roomType: "Single", salesperson: "Minh Tuấn", date: "2025-04-21", time: "09:00", duration: 60, notes: "Khách quan tâm tầng 2 trở lên", color: "indigo" },
  { id: "SA002", guest: "Lưu Thị Phương", roomType: "Double", salesperson: "Thu Hương", date: "2025-04-21", time: "11:00", duration: 30, notes: "Cần phòng gần thang máy", color: "emerald" },
  { id: "SA003", guest: "Trương Công Đạt", roomType: "Single", salesperson: "Minh Tuấn", date: "2025-04-22", time: "10:00", duration: 60, notes: "Đã xem qua website", color: "indigo" },
  { id: "SA004", guest: "Lê Văn Quân", roomType: "Triple", salesperson: "Quang Vinh", date: "2025-04-22", time: "14:00", duration: 60, notes: "Nhóm 3 sinh viên", color: "amber" },
  { id: "SA005", guest: "Ngô Thị Hoa", roomType: "Double", salesperson: "Thu Hương", date: "2025-04-23", time: "09:30", duration: 30, notes: "Khách VIP giới thiệu", color: "emerald" },
  { id: "SA006", guest: "Bùi Tiến Dũng", roomType: "Single", salesperson: "Quang Vinh", date: "2025-04-23", time: "15:00", duration: 60, notes: "", color: "amber" },
  { id: "SA007", guest: "Phạm Thị Lan", roomType: "Double", salesperson: "Minh Tuấn", date: "2025-04-24", time: "10:30", duration: 30, notes: "Muốn xem cả tòa B và C", color: "indigo" },
];
